...
import "../../interfaces/IGaugeUpgradeable.sol";
 ...
 */
abstract contract GaugeUpgradeable is Initializable, RewardManager, IGaugeUpgradeable {
    ...
    function __Gauge_init(address _veToken, address _gaugeController) internal initializer {
        veToken         = IVeToken(_veToken);
        gaugeController = _gaugeController;
        token           = IGaugeController(_gaugeController).token();
    }
